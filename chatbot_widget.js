    ...
    // Warn when the page is being closed or reloaded
        ...
        function handleSaveUserDetails() {
            ...
            const details = { email, firstName, lastName, phone, city, postcode, country };
        ...
        function handleSaveUserDetails2() {
            ...
            const details = { firstName, lastName, email, phone, company, street, postcode, city, country };
        ...
        MRChatbot.append(loadingContainer,feedbackModal, MRheader, MRChatContainer, MRChatInput, userDetailsModal, userDetailsModal2, userDetailsModal3)
